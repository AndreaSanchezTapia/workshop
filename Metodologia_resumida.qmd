...
A conectividade local é uma medida de facilitação ao deslocamento de organismos entre os elementos que compõem a paisagem (ou tipos de uso e cobertura do solo). A conectividade é maior quanto menor for a resistência que esses elementos oferecem ao deslocamento dos organismos, representando o grau de permeabilidade da paisagem (ou reciprocamente o grau de resistência) em torno de cada célula (ou pixel) avaliada.
A partir do mapa de uso e cobertura do solo, incluindo a presença de infraestruturas energéticas e de transporte, foram atribuídos, para cada classe de uso e cobertura do solo, pesos de resistência ao movimento de organismos, de modo que áreas naturais apresentam o valor mínimo e áreas com intervenção antrópica intensa (áreas urbanas) o valor máximo.

Uma vez atribuídos pesos de resistência para cada classe de uso e cobertura do solo, a conectividade local foi estimada plea média ponderada das resistências dentro um raio de vizinhança de aproximadamente 2070 m, tendo os pesos um decaimento linear pela distância da célula focal.

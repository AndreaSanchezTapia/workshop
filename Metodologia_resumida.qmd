...
A metodologia proposta para identificar os sítios resilientes às mudanças climáticas [@anderson_estimating_2014; @anderson_resilient_2016; @anderson_resilient_2016-1; e @anderson_resilient_2023] envolve a divisão do espaço geográfico em regiões eco-geológicas, que são similares na sua geologia, geomorfologia, vulnerabilidade ao intemperismo, formação de solos e biodiversidade.
Dentro de cada região são mapeadas a **heterogeneidade da paisagem** e a **conectividade local**, que posteriomente, compõem a resiliência da paisagem (@fig1).
...
![Figura 1 - Fluxograma da análise de resiliência da paisagem.](figs/Diagrama_metodologia.png)(#fig1)
...
Posteriomente, os valores de Z são combinados em heterogeneidade da paisagem, exceto conectividade local.

### Resiliência: combinando heterogeneidade da paisagem e conectividade local

Finalmente, a resiliência da paisagem é determinada pela média heterogeneidade da paisagem e valor de Z da conectividade local:

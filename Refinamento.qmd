...
No nosso estudo, optamos por utilizar o *Topographic Position Index* (TPI) (Theobald et al. 2015), por permitir considerar o efeito de diferentes escalas espaciais no cálculo da posição topográfica. Esse índice de posição topográfica média é descrito como:
...
![Histogramas da densidade de pixels (calculada em porcentagem) dos valores de heterogeneidade da paisagem para fitofisionomias campestres e florestais em altas e baixas altitudes.](figs/Figura_hist_campos_floresta.png){#fig-alta-baixa width="800" height="800" fig-align="center"}

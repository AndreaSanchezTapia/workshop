...
As formas de relevo representam a variação na umidade, exposição à radiação solar, velocidade de ventos e deposição de sedimentos na paisagem [@dobrowski_climatic_2011; @anderson_resilient_2016]. Essa classificação é determinada pelas variáveis de **declividade do relevo** (_slope_), **orientação do relevo** (_aspect_), **índice de posição topográfica** (_topographic position index_), **índice de umidade** (_moisture index_) e distribuição de **rios** e **lagos**.

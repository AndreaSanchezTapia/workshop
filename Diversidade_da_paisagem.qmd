...
![Classificação de formas de relevo de acordo com a declividade do relevo, índice de posição topográfica,
  orientação do relevo, índice de umidade, rios e lagos. Baseado na classificação de @anderson_resilient_2016.](figs/landform_scheme.png){#fig-landforms width="500" fig-align="center"}

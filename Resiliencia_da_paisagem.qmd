...
Com a sobreposição das duas imagens classificadas por quartis, geramos uma combinação de classes (11 - 44) para a resiliência da paisagem, que tem como objetivo mostrar as áreas onde os resultados das duas métricas se sobrepõem ou divergem, baseado na escala de cor escolhida (@fig-histograma). Essas classes podem ser agrupadas em quadrantres (Q1, Q2, Q3 e Q4) indicando tanto menor (Q1) e maior (Q4) resiliência, quanto maior efeito das camadas de heterogeneidade da paisagem (Q2) e de conectividade local (Q3) isoladamente.

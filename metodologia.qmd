...
Sua avaliação é baseada em um modelo de _landforms_, derivado de um modelo digital de elevação (DEM) com resolução de 30 m, que classifica a superfície em diversas categorias, como por exemplo:

...
A Resiliência da Paisagem foi calculada como a média entre os valores padronizados (${Z}$) de [__Diversidade da Paisagem__](#diversidade-da-paisagem) e [__Conectividade Local__](#conectividade-local). Todas as imagens utilizadas para o calculo de Resiliência estão na escala de 90 metros e foram reprojetadas para o _DATUM WGS84_.

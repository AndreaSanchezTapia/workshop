...
<<<<<<< HEAD
A conectividade local se refere à facilidade de movimentação potencial dos organismos dado o arranjo espacial dos elementos que compõem a paisagem (tipos de uso e cobertura do solo) e a resistência imposta por eles [@tischendorf_usage_2000; @anderson_mark_g_estimating_2014; @kumar_connectivity_2022].
...
MAPBIOMAS NOVA  
 -->
=======
A conectividade local se refere à facilidade de movimentação potencial dos organismos dado o arranjo espacial dos elementos que compõem a paisagem (tipos de uso e cobertura do solo) e a resistência imposta por eles (Tischendorf & Fahrig 2000, Anderson 2014, Kumar & Cushman 2022). A análise apresentada aqui foca em ecossistemas terrestres, avaliando a resistência da paisagem à movimentação de organismos terrestres entre as diferentes classes de uso e cobertura do solo. Portanto, ecossistemas aquáticos, como grandes rios, podem ser considerados como barreiras ao deslocamento dessas espécies.
...
>>>>>>> 738d3263d654ba76872c402e1ea1c7ae95792f6e
...
![Fluxograma indicando as etapas da análise de conectividade local.](figs/Fluxograma_resistencia_com_Kernel_jan24_corrigido.jpg){#fig-fluxograma height="800" width="900" fig-align="center"}
